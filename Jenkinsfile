pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://100.29.13.216:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/michanagatlajaswanth/frontapp1.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://100.29.13.216:9090/springapp1"
            echo "✅ Frontend deployed: http://100.29.13.216:9090/frontapp1"
        }
        failure {
